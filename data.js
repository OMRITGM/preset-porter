...
const QUESTIONS = [
  { id: "budget", q: "מה התקציב למדפסת עצמה?", a: [
    // min = רצפה רכה (75% מתחתית הטווח): מי שהקצה ₪8,000 לא צריך לקבל מדפסת של ₪900
    ["עד ₪1,200", { min: 0, max: 1200 }], ["₪1,200 עד ₪2,500", { min: 900, max: 2500 }],
    ["₪2,500 עד ₪5,000", { min: 1875, max: 5000 }], ["₪5,000 עד ₪8,000", { min: 3750, max: 8000 }], ["מעל ₪8,000", { min: 6000, max: Infinity }]] },
  { id: "use", q: "מה בעיקר תדפיסו?", a: [
    ["צעצועים, קישוטים, גאדג'טים לבית", { want: ["easy"] }],
    ["חלקים פונקציונליים — לרכב, לכלים, לחוץ", { want: ["enclosed", "eng"] }],
    ["דברים גדולים — קסדות, קוספליי, ארגוניות", { want: ["big"] }],
